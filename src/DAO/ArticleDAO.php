...
class ArticleDAO extends DAO
{
    ...
    {
        $sql = 'SELECT article.id, article.title, article.standfirst, article.content, user.pseudo, article.createdAt FROM article INNER JOIN user ON article.user_id = user.id ORDER BY article.id DESC';
